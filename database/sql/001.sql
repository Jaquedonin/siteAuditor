...
CREATE TABLE IF NOT EXISTS `tce-mapa`.`professores` (
...
CREATE TABLE IF NOT EXISTS `tce-mapa`.`alunos` (
  `id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tce-mapa`.`escolas` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `cidade_id` INT(11) NOT NULL,
  `nome` VARCHAR(255) NOT NULL,
  `sigla` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_escolas_cidades_idx` (`cidade_id` ASC),
...
CREATE TABLE IF NOT EXISTS `tce-mapa`.`cidades` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tce-mapa`.`videos` (
  `id` INT(11) NOT NULL,
  `professor_escola_id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tce-mapa`.`professores_escolas` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
